...
ActiveRecord::Schema[7.0].define(version: 2023_08_06_092405) do
  ...
  create_table "recipe_checkings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["meal_plan_id"], name: "index_recipe_checkings_on_meal_plan_id"
    t.index ["recipe_id"], name: "index_recipe_checkings_on_recipe_id"
  end
