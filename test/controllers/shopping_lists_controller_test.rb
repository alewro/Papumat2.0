...
class ShoppingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list" do
    assert_difference("ShoppingList.count") do
      post shopping_lists_url, params: { shopping_list: { is_bought: @shopping_list.is_bought, product_category: @shopping_list.product_category, product_name: @shopping_list.product_name, product_quantity: @shopping_list.product_quantity } }
    end
  ...
  test "should update shopping_list" do
    patch shopping_list_url(@shopping_list), params: { shopping_list: { is_bought: @shopping_list.is_bought, product_category: @shopping_list.product_category, product_name: @shopping_list.product_name, product_quantity: @shopping_list.product_quantity } }
